...
if(isset($_GET["wl_value"]))
{
	  

	  $wl_value = $_GET["wl_value"];

	  $query = "INSERT INTO `waterlevel`(wl_value,reading_time) VALUES('$wl_value',CURRENT_TIMESTAMP())";
